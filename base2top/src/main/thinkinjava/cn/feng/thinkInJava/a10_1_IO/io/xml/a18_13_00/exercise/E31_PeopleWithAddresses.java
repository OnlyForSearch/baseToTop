package cn.feng.thinkInJava.a10_1_IO.io.xml.a18_13_00.exercise;
 ...
 * *********************************************
 */
/**在 Person.java and People.java.中添加恰当的地址信息*/
import nu.xom.*;
...
public class E31_PeopleWithAddresses {
    ...
    public static void main(String[] args) throws Exception {
        List<Person> people = Arrays.asList(new Person("Dr. Bunsen", "Honeydew", "Street 1", "New York", "NY", 10001), new Person("Gonzo", "The Great", "Street 2", "New York",
                "NY", 20002), new Person("Phillip J.", "Fry", "Street 3", "New York", "NY", 30003));
