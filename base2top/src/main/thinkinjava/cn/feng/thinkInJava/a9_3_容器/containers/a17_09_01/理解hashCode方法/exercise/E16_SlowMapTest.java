 ...
 * *********************************************
 *//**
 * 将Map.java中的测试应用于SlowMap,验证并修改它,使其能正常工作
 * */

import cn.feng.thinkInJava.a9_3_容器.Map.MapEntry;
...
Values: [O0, M0, K0, I0, W0, G0, Y0, E0, S0, C0, U0, A0, P0,
Q0, N0, L0, J0, H0, V0, F0, X0, D0, R0, B0, T0]
{14=O0, 12=M0, 10=K0, 8=I0, 22=W0, 6=G0, 24=Y0, 4=E0, 18=S0,
...
Thinking in Java, 4 434 th Edition Annotated Solution Guide
map.isEmpty(): true
map.isEmpty(): true
*///:~

/**
 * As stated in the JDK, entrySet( ) should return a set view of the mappings
 * contained in a map. SlowMap returns a fresh copy of the keys instead, so
 * integrating it into Maps.java is troublesome. The returned entry set doesn’t
 * properly remove elements, i.e., operations on the set do not change the map. The
 * SlowMap2 class fixes this; see the difference in the output.
 */