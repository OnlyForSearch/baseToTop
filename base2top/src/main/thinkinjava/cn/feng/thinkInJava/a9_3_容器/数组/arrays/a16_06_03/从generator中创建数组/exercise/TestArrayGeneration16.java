package cn.feng.thinkInJava.a9_3_容器.数组.arrays.a16_06_03.从generator中创建数组.exercise;// arrays/TestArrayGeneration16.java
...
/**
 * 从CountingGenerator.java开始,创建一个SkipGenerator类,他可以根据构造器参数,通过递增
 * 产生新值,修改TestArrayGeneration.java ,以展示新类可以正确工作
 */
