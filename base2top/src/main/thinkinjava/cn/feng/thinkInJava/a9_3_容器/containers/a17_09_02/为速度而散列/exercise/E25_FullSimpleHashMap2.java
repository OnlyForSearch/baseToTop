 ...
 * Thinking in Java, 4 446 th Edition Annotated Solution Guide
 * this new approach works correctly.
 * *********************************************
 */
/**
 * 修改MapEntry,使其成为一种自包含的单向链表(每个MapEntry应该都有一个指向下一个MapEntry的向前链接,),从而不用对每个桶位都使用ListIterator,修改SimpleHashMap中
 * 其余的代码,使得这种新方式可以正确的工作
 * */
