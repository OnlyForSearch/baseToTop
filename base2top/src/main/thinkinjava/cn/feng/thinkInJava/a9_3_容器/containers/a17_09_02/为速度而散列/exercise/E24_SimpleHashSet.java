 ...
 * *********************************************
 */
//模仿SimpleHashMap中的例子写一个SimpleHashSet,并作测试
...
*///:~
/**
 * This contains keys but not values. Also, we declare different methods in Set than
 * in AbstractSet; the above methods are the only ones necessary to implement
 * the SimpleHashSet. Pay special attention to the iterator( ) method.
 */