package cn.feng.thinkInJava.a9_3_容器.数组.arrays.a16_04_00.多维数组.exercise;// arrays/Ex6.java
...
/**
 * 编写一个方法,他接受两个表示二维数组尺寸的int参数,这个方法应该这两个根据尺寸参数,
 * 创建并填充一个BerylliumSphere二维数组
 */
public class Ex6 {
