 ...
 * *********************************************
 *//**
 * 修改 net/mindview/util/Tuple.java,通过添加hashCode()和equals()方法,并未没中过
 * Tuple的类型都实现一个Comparable,使其成为一个通用类
 * */
    ...
    public static class T2<A, B> implements Comparable<T2<A, B>> {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof T2) {
                ...
                return (first == null ? o.first == null : first.equals(o.first)) && (second == null ? o.second == null : second.equals(o.second));
            }
            return false;
        }
...
/**
 * We refactor the code in net/mindview/util/Tuple.java to incorporate the
 * Comparable for each type of Tuple. When a class extends a concrete
 * Comparable class (as T3<A,B,C> extends T2<A,B> in the original program),
 * and adds a significant field, there is no way to simultaneously implement
 * compareTo( ) correctly. Therefore we use composition instead of inheritance.
 * The same holds true for equals( ). For more information see Effective Java by
 * Joshua Bloch (Addison-Wesley, 2001). Our solution follows Bloch’s
 * recommendations.
 */
