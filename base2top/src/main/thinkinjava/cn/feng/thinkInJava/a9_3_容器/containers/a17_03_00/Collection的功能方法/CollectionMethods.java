package cn.feng.thinkInJava.a9_3_容器.containers.a17_03_00.Collection的功能方法;
...
/**
 * Collection的功能方法
 *请注意，其中不包括随机访问选择元素的get()方法。因为Collection包括Set，而Set是自己维护内部顺序的
 * （这使得随机访问变得没有意义）。因此，如果想检查Collection中的元素，就必须使用迭代器。
 * @author fengyu
 * @date 2015年8月9日
 *///这个说明了各种Collec子类的"最基本的共同特性"
