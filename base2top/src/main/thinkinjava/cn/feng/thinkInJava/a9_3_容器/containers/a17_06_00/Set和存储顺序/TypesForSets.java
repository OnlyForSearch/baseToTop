package cn.feng.thinkInJava.a9_3_容器.containers.a17_06_00.Set和存储顺序;
...
class TreeType extends SetType implements Comparable<TreeType> {
    ...
    /**在compareTo()中，我没有使用“简洁明了”的形式return i – i2，因为这是一个常见的编程错误，它只有在i和i2都是无符号的int时才能正确工作。对于Java的有符号int，它就会出错，因为int不够大，不足以表现两个有符号的int的差。例如i是很大的正整数，而j是很大的负整数，i-j就会溢出并且返回负值，这就不正确了。*/
