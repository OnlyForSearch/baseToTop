 ...
 * HashMaps.
 * *********************************************
 *///修改前一个练习中的类,使其可以作用于HashSet,并可以用作,HashMap中的键
...
IVPJWjR], [s1 = gqiaxxE, s2 = AJJmzMs], [s1 = opwBTwV, s2 =
...
naMesbt], [s1 = TQzGSrL, s2 = rcVwhKO], [s1 = smwHLGE, s2 =
ahKcxrE]]
hm = {[s1 = JYmXfyL, s2 = LXdaCcH]=13, [s1 = vWlnklx, s2 =
ieETLdl]=12, [s1 = kkXmZpE, s2 = lUnpFsT]=0, [s1 = YOzPgpj,
s2 = HZAeudW]=19, [s1 = eRzDqLz, s2 = lEcBfEA]=16, [s1 =
DPbmXRQ, s2 = TmKrsgn]=14, [s1 = hLIpVVl, s2 = pNVvUuk]=15,
[s1 = vAusWxO, s2 = ikOSUvL]=9, [s1 = BcatxLS, s2 =
...
[s1 = hfFkVrA, s2 = gepwlXE]=2, [s1 = PKNjWUl, s2 =
MJOTlae]=3, [s1 = haoyWJS, s2 = yIPMqvD]=7, [s1 = CmEtqPh,
s2 = yXPQvPa]=17, [s1 = GpArCjV, s2 = SpNQlmO]=8, [s1 =
olwrSJY, s2 = FSRWuZJ]=4}
*///:~
/**
 * You must add hashCode( ) and equals( ) to use a class as a key in a hashed
 * container.
 */
