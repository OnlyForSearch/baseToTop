package cn.feng.thinkInJava.b7_1_swt.gui.a22_08_04.文本域.exercise;
...
/**
* This exercise forces you to study the example thoroughly in order to find where
to make the changes (the second and fourth lines of UpperCaseDocument).
* */
