package cn.feng.thinkInJava.b7_1_swt.gui.a22_08_13.菜单.exercise;
...
class DynamicMenus extends JFrame {
    ...
    private Set<String> words = new TreeSet<String>(new TextFile("E03_DirSize.java", "\\W+"));
    ...
    tm2 = new JMenu("Words Starting With LCC"), // All other words not belonging to the above groups:
...
/**
 * Notice that we group single words as standalone menu items (categorized by
 their first character) under corresponding top-level menus. The
 swt/Menus.java program in TIJ4 shows another approach to the solution.
 * */