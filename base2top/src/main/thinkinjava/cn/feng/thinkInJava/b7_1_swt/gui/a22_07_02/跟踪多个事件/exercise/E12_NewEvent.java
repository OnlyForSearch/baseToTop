...
class TrackEvent extends JFrame {
    ...
    private String[] event = {"actionPerformed", "stateChanged", "focusGained", "focusLost", "keyPressed", "keyReleased", "keyTyped", "mouseClicked", "mouseEntered", "mouseExited", "mousePressed", "mouseReleased", "mouseDragged", "mouseMoved"};
...
/**
 *
 * JButton has many “add listener” methods. An obvious choice is
 addActionListener( ), but we also added one for addChangeListener( ).
 * */