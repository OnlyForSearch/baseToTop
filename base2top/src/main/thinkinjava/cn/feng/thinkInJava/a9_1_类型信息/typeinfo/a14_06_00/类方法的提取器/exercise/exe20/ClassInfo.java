package cn.feng.thinkInJava.a9_1_类型信息.typeinfo.a14_06_00.类方法的提取器.exercise.exe20;// typeinfo/ClassInfo.java
...
/**
 * 请从http://java.sun.com.上提供的JDK文档中找出java.lang.Class的接口,写一个程序,
 * 他能够接受命令行参数所指定的类名称,然后使用Class的方法打印所有该类可以获得的信息
 * , 用标准程序库的类和你自己写的类,分别测试这个类
 */
