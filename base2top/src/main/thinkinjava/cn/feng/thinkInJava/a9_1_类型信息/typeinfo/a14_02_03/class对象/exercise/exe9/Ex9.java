package cn.feng.thinkInJava.a9_1_类型信息.typeinfo.a14_02_03.class对象.exercise.exe9;// typeinfo/Ex9.java
...
//修改前一个练习,然后这个方法使用Class.getDeclaredFields() 来打印一个类型的域的相关信息
class A {
