package cn.feng.thinkInJava.a9_1_类型信息.typeinfo.a14_03_03;
...
import cn.feng.thinkInJava.a9_1_类型信息.typeinfo.pets.a14_03_01.ForNameCreator;
...
public class PetCount {
    ...
    public static void countPets(PetCreator creator) {
        ...
        for (Pet pet : creator.createArray(20)) {
            ...
            //instanceof有比较严格的箱子:只可将其与命名类型进行比较,而不能与Class对象比较
