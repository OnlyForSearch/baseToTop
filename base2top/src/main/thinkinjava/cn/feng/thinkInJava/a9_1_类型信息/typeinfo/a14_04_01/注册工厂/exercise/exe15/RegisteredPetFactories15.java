package cn.feng.thinkInJava.a9_1_类型信息.typeinfo.a14_04_01.注册工厂.exercise.exe15;// typeinfo/RegisteredPetFactories15.java
...
/**
 * 使用注册工程来实现一个新的PetCreator,并修改Pets的外观,使其使用这个新的
 * Creator而非另外两个Creator,确保使用Pets.java的其他示例然可以正常工作
 */
