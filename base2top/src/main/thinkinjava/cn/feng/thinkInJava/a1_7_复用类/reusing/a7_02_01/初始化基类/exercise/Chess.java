package cn.feng.thinkInJava.a1_7_复用类.reusing.a7_02_01.初始化基类.exercise;// reusing/Chess.java
...
class BoardGame extends Game {
    ...
    BoardGame(int i) {
        ...
        super(i); // else: "cannot find symbol: constructor Game()//调用基类是导出类构造器要做的第一件事
