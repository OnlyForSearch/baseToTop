package cn.feng.thinkInJava.a7_4_异常.exceptions.a12_04_00.创建自定义异常.a12_04_01.exercise;// exceptions/Ex1.java
...
*////在try抛出一个Exception对象,传递给一个字符串参数构造器,在catch中捕获异常,添加finally字句,打印消息证明这里确实执行了
