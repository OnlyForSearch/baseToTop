package cn.feng.thinkInJava.a7_4_异常.exceptions.a12_09_00.异常的限制.exercise;// exceptions/StormyInning20.java
...
/**
 * 修改StormyInning.java ,加一个UmpireArgument异常,和一个能抛出异常的方法.测试一下修改后的异常
 * 体系
 */
...
public class StormyInning20 extends Inning implements Storm {
    ...
    public StormyInning20() throws UmpireArgument, RainedOut, BaseballException {}
