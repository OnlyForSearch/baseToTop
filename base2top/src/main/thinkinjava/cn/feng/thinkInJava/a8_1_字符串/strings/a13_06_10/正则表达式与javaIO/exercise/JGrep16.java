package cn.feng.thinkInJava.a8_1_字符串.strings.a13_06_10.正则表达式与javaIO.exercise;// strings/JGrep16.java
...
/**
 * 修改JGrep.java类令其能够接受一个目录或文件为参数(例如如果传入的目录,就搜索目录中的所有文件)
 * .提示可以用下面的方法获得所有文件的名字列表File[] files = new File(".").listFiles();
 */
