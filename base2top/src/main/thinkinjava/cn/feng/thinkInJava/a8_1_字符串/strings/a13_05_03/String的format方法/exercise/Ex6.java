package cn.feng.thinkInJava.a8_1_字符串.strings.a13_05_03.String的format方法.exercise;// strings/Ex6.java
...
/**
 * 创建一个包含int,long,float,double的元素的类,应用toString*()方法为这个类编写toString()方法,
 * 并且证明他能正确工作
 * *
 */
public class Ex6 {
