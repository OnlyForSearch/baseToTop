package cn.feng.thinkInJava.a8_1_字符串.strings.a13_06_10.正则表达式与javaIO.exercise;// strings/JGrep15.java
...
/**
 * 修改JGrep.java类令其能够接受模式标志参数(例如Pattern.CASE_INSENSITIVE, Pattern.MULTILINE)
 */
