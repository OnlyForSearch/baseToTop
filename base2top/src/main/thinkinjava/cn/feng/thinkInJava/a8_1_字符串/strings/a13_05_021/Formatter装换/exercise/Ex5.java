package cn.feng.thinkInJava.a8_1_字符串.strings.a13_05_021.Formatter装换.exercise;// strings/Ex5.java
...
import cn.feng.thinkInJava.a8_1_字符串.strings.a13_05_021.Formatter装换.Conversion;

import java.math.BigInteger;
import java.util.Formatter;

/**
 * 针对前边表格中的各种基本转化类型,请利用所有可能的格式修饰符,写一个尽可能复杂的格式化表达式
 */
