package cn.feng.thinkInJava.a9_2_泛型.generics.a15_08_01.创建类型的实例.exericse.exe22;// generics/ClassTypeCreator22.java
...
/**
 * 使用类型标签与反射来创建一个方法,将使用newInstance()的参数版本来创建某个类的对象,这个类拥有一个具有参数的的构造器
 */
class Building {}
...
public class ClassTypeCreator22<T> {
     ...
     */
    public Object createNew(String typename, Object... args) throws IllegalAccessException, InstantiationException, ClassNotFoundException, NoSuchMethodException,
