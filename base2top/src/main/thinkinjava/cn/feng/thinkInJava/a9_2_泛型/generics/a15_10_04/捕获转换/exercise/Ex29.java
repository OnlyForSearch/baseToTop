package cn.feng.thinkInJava.a9_2_泛型.generics.a15_10_04.捕获转换.exercise;// generics/Ex29.java
...
/**
 * 创建一个泛型方法,他接受一个Holder<List<?>>.,对于这个Holder以及List确定那些方法是可以调用的
 * ,哪些方法是不可以调用的,用List<Holder<?>>.作为参数重复练习
 */
...
public class Ex29 {
    ...
    static void f2(List<Holder<?>> list) {
        ...
        println("Elements of list: ");
        for (Holder h : list)
            println("h.get() = " + h.get().getClass().getSimpleName() + " " + h.get());
        ...
        println("((ArrayList)list).clone().getClass() = " + ((ArrayList) list).clone().getClass());
        ...
        for (Holder h : list)
            println(h.get().getClass().getSimpleName() + " " + h.get());
        println("list.contains(list.set(3, h4): " + list.contains(list.set(3, h4)));
        ...
        println(list.get(0).getClass() + ": " + list.get(0).get().getClass().getSimpleName() + ", " + list.get(0).get());
        println(list.get(1).getClass() + ": " + list.get(1).get().getClass().getSimpleName() + ", " + list.get(1).get());
        println(list.get(2).getClass() + ": " + list.get(2).get().getClass().getSimpleName() + ", " + list.get(2).get());
