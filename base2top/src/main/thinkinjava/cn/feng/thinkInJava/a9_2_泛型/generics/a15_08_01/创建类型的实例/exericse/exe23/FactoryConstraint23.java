package cn.feng.thinkInJava.a9_2_泛型.generics.a15_08_01.创建类型的实例.exericse.exe23;// generics/FactoryConstraint23.java

// TIJ4 Chapter Generics, Exercise 23, page 667
// Modify FactoryConstraint.java so that create() takes an argument.
//修改FactoryConstraint.java ,使得create() 可以接受一个参数
