package cn.feng.thinkInJava.b3_1_多线程并发.concurrency.a21_05_04.土司BlockingQueue.exercise;
 ...
 *//**
 *
 * 修改 ToastOMatic.java ,使用两个单独的组装线来创建涂有花生黄油和果冻的吐司三明治
 * (一个用花生黄油,第二个用于果冻,然后把两条线合并)
 * */
 ...
 * The finished sandwiches no longer come in predefined order because the two
 ...
 busy-wait loop. We add only Alternator and Merger; Toaster, Butterer,
 Jammer and Eater remain the same.
 *
 * */