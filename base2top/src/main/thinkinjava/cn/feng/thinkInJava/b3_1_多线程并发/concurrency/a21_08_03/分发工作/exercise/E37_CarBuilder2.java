package cn.feng.thinkInJava.b3_1_多线程并发.concurrency.a21_08_03.分发工作.exercise;
 ...
 */
/**
 * 修改CarBuilder.java,在汽车构建过程中添加一段程序,即添加排气系统,车身,和保险杠
 * ,与第二阶段相同,假设这些处理可以由机器人同时执行
 *
 * */
...
class Car2 {
    ...
    private boolean engine = false, driveTrain = false, wheels = false, exhaustSystem = false, body = false, fender = false;
    ...
    public synchronized String toString() {
        return "Car " + id + " [" + " engine: " + engine + " driveTrain: " + driveTrain + " wheels: " + wheels + " exhaust system: " + exhaustSystem + " body: " + body + " fender: " + fender + "]";
    }
}
