package cn.feng.thinkInJava.b3_1_多线程并发.concurrency.a21_06_05.死锁.exercise;
...
/**
 * 修改 DeadlockingDiningPhilosophers.java,使得当哲学家使用完筷子之后,吧筷子放在
 * 筷笼里,当哲学家要就餐时候,他们就从筷笼取出两根可用的筷子,这消除了死锁的可能吗?"
 * 你能仅仅通过减少可用筷子数目就重新引入死锁吗?
 *
 * */
 ...
 * We use ChopstickQueue to create the ChopstickBin, so it gains all of
 ...
 when too few chopsticks remain. The results are the same, with the flaw that an
 equal number of chopsticks and philosophers can quickly deadlock, but a single
 extra chopstick prevents this.
 */
