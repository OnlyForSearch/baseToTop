package cn.feng.thinkInJava.b3_1_多线程并发.concurrency.a21_08_03.分发工作.exercise.E38_HouseBuilder;
 ...
 * *******************************************************
 */
//使用 CarBuilder.java,中的方式,对本章中给出的房屋构建过程建模
...
class House {
    ...
    private boolean steel = false, concreteForms = false, concreteFoundation = false, plumbing = false, concreteSlab = false, framing = false;
    ...
    public synchronized String toString() {
        return "House " + id + " [" + " steel: " + steel + " concreteForms: " + concreteForms + " concreteFoundation: " + concreteFoundation + " plumbing: " + plumbing + " concreteSlab: " + concreteSlab + " framing: " + framing + "]";
    }
}
...
/**
 * Only the names of the entities change: Car -> House, Assembler ->
 HouseBuilder, Robot -> Team, and RobotPool -> TeamPool. The
 program logic remains basically the same.
 * */