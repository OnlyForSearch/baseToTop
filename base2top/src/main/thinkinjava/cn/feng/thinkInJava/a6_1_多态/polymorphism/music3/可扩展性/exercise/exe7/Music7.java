...
* your new type.
*///验证多态是否适用于添加新的类型
package cn.feng.thinkInJava.a6_1_多态.polymorphism.music3.可扩展性.exercise.exe7;
...
public class Music7 {
    ...
    public static void main(String[] args) {
        ...
        Instrument[] orchestra = {new Wind(), new Percussion(), new Stringed(), new Brass(), new Woodwind(), new Piano()};
        tuneAll(orchestra);
