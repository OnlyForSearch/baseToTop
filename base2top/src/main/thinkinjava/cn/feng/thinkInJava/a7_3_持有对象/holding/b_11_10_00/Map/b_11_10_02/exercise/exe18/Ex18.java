package cn.feng.thinkInJava.a7_3_持有对象.holding.b_11_10_00.Map.b_11_10_02.exercise.exe18;// holding/Ex18.java
...
*///用键值对填充一个HashMap.并打印结果,通过散列码来展示其排序,抽取这些键值对,按照键进行排序,并
//将结果置于一个LinkedHashMap中,展示其维护的插入顺序
