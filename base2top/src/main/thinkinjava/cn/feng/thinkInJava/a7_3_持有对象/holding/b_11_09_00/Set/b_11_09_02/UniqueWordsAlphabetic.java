package cn.feng.thinkInJava.a7_3_持有对象.holding.b_11_09_00.Set.b_11_09_02;//: holding/UniqueWordsAlphabetic.java
...
public class UniqueWordsAlphabetic {
    ...
    public static void main(String[] args) {
        Set<String> words = new TreeSet<String>(String.CASE_INSENSITIVE_ORDER);//向构造器传入比较器,按照字母顺序排序
