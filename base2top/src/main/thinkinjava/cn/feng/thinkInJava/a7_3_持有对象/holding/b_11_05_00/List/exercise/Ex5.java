package cn.feng.thinkInJava.a7_3_持有对象.holding.b_11_05_00.List.exercise;// holding/Ex5.java
...
* results.
*/
/**修改ListFeatures.java,让他使用Integer(记住自动包装机制),而不是Pet,并解释在结果上有什么不同*/
import java.util.*;
...
public class Ex5 {
    ...
    // method to makeD1 a List<Integer> with random values < n:
