package cn.feng.thinkInJava.a7_3_持有对象.holding.b_11_09_00.Set.b_11_09_02.exercise;// holding/Vowels16.java
...
/**
 * 创建一个元音字母Set,对SetOperations操作操作,计数并显示在每一个输入单词中的元音字母,并显示输入文件中的所有元音字母的数量
 * 总和
 */
