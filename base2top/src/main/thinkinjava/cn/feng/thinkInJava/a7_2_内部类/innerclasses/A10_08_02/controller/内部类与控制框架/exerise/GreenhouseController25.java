package cn.feng.thinkInJava.a7_2_内部类.innerclasses.A10_08_02.controller.内部类与控制框架.exerise;// innerclasses/GreenhouseController25.java
...
public class GreenhouseController25 {
    ...
    public static void main(String[] args) {
        ...
        Event[] eventList = {gc.new ThermostatNight(0), gc.new LightOn(200), gc.new LightOff(400), gc.new WaterOn(600), gc.new WaterMistOn(650), gc.new WaterMistOff(700), gc.new
                WaterOff(800), gc.new ThermostatDay(1400),};
