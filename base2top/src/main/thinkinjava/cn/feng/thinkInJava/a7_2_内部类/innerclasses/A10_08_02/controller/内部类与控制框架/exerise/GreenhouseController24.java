package cn.feng.thinkInJava.a7_2_内部类.innerclasses.A10_08_02.controller.内部类与控制框架.exerise;// innerclasses/GreenhouseController24.java
...
public class GreenhouseController24 {
    ...
    public static void main(String[] args) {
        ...
        Event[] eventList = {gc.new ThermostatNight(0), gc.new LightOn(200), gc.new FanOn(300), gc.new LightOff(400), gc.new FanOff(500), gc.new WaterOn(600), gc.new WaterOff
                (800), gc.new ThermostatDay(1400),};
